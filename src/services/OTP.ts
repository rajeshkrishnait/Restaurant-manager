...
import { IOtpDTO} from '@/interfaces/IOtp';
...
export default class OtpService {
  ...
  // public async verify(verification_key:string, otp:string, check:string):Promise<{status:string}>{
  //   try{
  ...
  //     const otp_instance= await this.otpModel.findOne({where:{id: obj._id}})
